...
const HeroSection = () => {
  return (
    <section className="xl:px-30 my-auto flex h-full w-full flex-col-reverse items-center justify-center gap-5 px-5 md:h-2/3 md:flex-row md:justify-between md:gap-5 md:px-10 lg:my-0 lg:gap-10 lg:px-20">
